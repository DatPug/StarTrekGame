...
public class TwoPlayerTurn {
	...
	public void twoPlayerTurn(Object ff, Object kf, Object rf) throws IOException {

		ChooseShips choose = new ChooseShips();
		ff = choose.x; // calls x from ChooseShips and sets to ff
		kf = choose.y; // calls y from ChooseShips and sets to kf
